  ...
  <header class="masthead masthead--catalog">
    <div class="brand">
      ...
      <div>
        ...
        <p class="subtitle">v2026 · {len(rows)} Conditional Access policies · Groups by persona · New deploys: mostly <strong>Report-only</strong>; including device registration MFA (<strong>CA112</strong>) in <strong>Report-only</strong>. <strong>CA111</strong>, <strong>CA202</strong>, <strong>CA204</strong>, <strong>CA302</strong>, <strong>CA303</strong>, <strong>CA603</strong>, <strong>CA606</strong>, <strong>CAA01</strong> default to <strong>Off</strong> (override with intent <code>deploymentState</code>); turn <strong>On</strong> in Entra when ready</p>
        <p class="catalog-nav">
